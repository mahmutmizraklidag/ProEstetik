...
namespace ProEstetik.Web.Areas.admin.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Keywords,MetaDescription,MetaTitle,Language")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Keywords,MetaDescription,MetaTitle,Language")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
